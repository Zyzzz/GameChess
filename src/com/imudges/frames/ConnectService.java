...
public class ConnectService extends JFrame implements DiyViews, ActionListener {
    ...
    public void initViews() {
        ...
        //JTextFiled
        text_host = new JTextField(MainFrames.host);
        text_port = new JTextField(MainFrames.port+"");
            ...
            if (Client.TestConnection(host, MainFrames.port)) {
                ...
                if (state_color == BoradFrame.STATE_BLACK) {
                    new Thread() {
                        @Override
                        public void run() {
                            BoradPanel panel = new BoradPanel(host, MainFrames.port, BoradFrame.STATE_CLIENT, BoradFrame.STATE_BLACK);
                    ...
                    new Thread() {
                        @Override
                        public void run() {
                            BoradPanel panel = new BoradPanel(host, MainFrames.port, BoradFrame.STATE_CLIENT, BoradFrame.STATE_WHITE);
